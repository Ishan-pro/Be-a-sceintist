...
const Navbar = () => {
  return (
    <nav className='bg-blue-800 p-3 text-white flex h-20 items-center lg:absolute lg:top-0 lg:left-0 w-full'>
...
function App() {
  return (
    <>
    <Navbar/>
    <main className='bg-gray-200 h-screen lg:grid lg:place-items-center'>
